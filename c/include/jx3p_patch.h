...
/*
 * jx3p_patch.h -- single source of truth for the JX-3P patch byte layout.
 *
 * Both the C decoder (c/decoder/) and C encoder (c/encoder/) include this
 * header; their existing public typedef names (jx3p_format, JX3P_PATCH) are
 * kept as aliases of jx3p_patch_t so neither tool's .c sources need to move.
 */
